#ifndef HALIDE_____bin___conv2D_fp_h
#define HALIDE_____bin___conv2D_fp_h
#include <stdint.h>
...
int conv2D_fp(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_kernel_buffer, struct halide_buffer_t *_bias_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int conv2D_fp_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *conv2D_fp_metadata() HALIDE_FUNCTION_ATTRS;

...
int tensor_d_mode_0_0_unroll = 1;
int tensor_d_mode_0_0_unroll_array[1] = {
1
};
...
int tensor_f_mode_0_0_unroll = 1;
int tensor_f_mode_0_0_unroll_array[1] = {
3
};
...
int tensor_e_mode_vals_0_unroll = 1;
int tensor_e_mode_vals_0_unroll_array[1] = {
5
};
int tensor_f_mode_vals_0_unroll = 1;
int tensor_f_mode_vals_0_unroll_array[1] = {
6
};
...
int tensor_d_mode_vals_0_unroll = 1;
int tensor_d_mode_vals_0_unroll_array[1] = {
8
};
...
for (int i = 0; i < tensor_d_mode_0_0_unroll; i++) {
  write_glb_memory(0x40000 * (tensor_d_mode_0_0_unroll_array[i]), (uint16_t * ) app_tensor_d_mode_0_0_data, app_tensor_d_mode_0_0_data_size / tensor_d_mode_0_0_unroll, i, tensor_d_mode_0_0_unroll);
}
...
for (int i = 0; i < tensor_f_mode_0_0_unroll; i++) {
  write_glb_memory(0x40000 * (tensor_f_mode_0_0_unroll_array[i]), (uint16_t * ) app_tensor_f_mode_0_0_data, app_tensor_f_mode_0_0_data_size / tensor_f_mode_0_0_unroll, i, tensor_f_mode_0_0_unroll);
}
...
for (int i = 0; i < tensor_e_mode_vals_0_unroll; i++) {
  write_glb_memory(0x40000 * (tensor_e_mode_vals_0_unroll_array[i]), (uint16_t * ) app_tensor_e_mode_vals_0_data, app_tensor_e_mode_vals_0_data_size / tensor_e_mode_vals_0_unroll, i, tensor_e_mode_vals_0_unroll);
}
for (int i = 0; i < tensor_f_mode_vals_0_unroll; i++) {
  write_glb_memory(0x40000 * (tensor_f_mode_vals_0_unroll_array[i]), (uint16_t * ) app_tensor_f_mode_vals_0_data, app_tensor_f_mode_vals_0_data_size / tensor_f_mode_vals_0_unroll, i, tensor_f_mode_vals_0_unroll);
}
...
for (int i = 0; i < tensor_d_mode_vals_0_unroll; i++) {
  write_glb_memory(0x40000 * (tensor_d_mode_vals_0_unroll_array[i]), (uint16_t * ) app_tensor_d_mode_vals_0_data, app_tensor_d_mode_vals_0_data_size / tensor_d_mode_vals_0_unroll, i, tensor_d_mode_vals_0_unroll);
}
}

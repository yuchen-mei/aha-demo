...
int tensor_D_mode_1_0_unroll = 1;
int tensor_D_mode_1_0_unroll_array[1] = {
3
};
int tensor_B_mode_2_0_unroll = 1;
int tensor_B_mode_2_0_unroll_array[1] = {
4
};
...
for (int i = 0; i < tensor_D_mode_1_0_unroll; i++) {
  write_glb_memory(0x40000 * (tensor_D_mode_1_0_unroll_array[i]), (uint16_t * ) app_tensor_D_mode_1_0_data, app_tensor_D_mode_1_0_data_size / tensor_D_mode_1_0_unroll, i, tensor_D_mode_1_0_unroll);
}
for (int i = 0; i < tensor_B_mode_2_0_unroll; i++) {
  write_glb_memory(0x40000 * (tensor_B_mode_2_0_unroll_array[i]), (uint16_t * ) app_tensor_B_mode_2_0_data, app_tensor_B_mode_2_0_data_size / tensor_B_mode_2_0_unroll, i, tensor_B_mode_2_0_unroll);
}
